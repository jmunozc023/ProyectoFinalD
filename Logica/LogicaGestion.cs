...
namespace Logica
{
    public class LogicaGestion
    {
        ...
        {
            gestion.Insertar(nombre, marca, modelo, Convert.ToInt32(estado), fecha, imagen, Convert.ToInt32(subcategoria), Convert.ToDouble(precio));
        }
        ...
        {
            gestion.Editar(nombre, marca, modelo, Convert.ToInt32(estado), fecha, imagen, Convert.ToInt32(subcategoria), Convert.ToDouble(precio), Convert.ToInt32(id));
        }
